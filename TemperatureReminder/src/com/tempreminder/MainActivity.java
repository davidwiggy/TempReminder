//*********************************************************************************************
//**Program:      Temperature Reminder                                                       **
//**Programmer:   Timothy David Wiggins                                                      **
//**PURPOSE:      The purpose of this program is to monitor the projected low temperature    **
//**PURPOSE:      each night of an entered zip code. If the temperature meets a condition,   **
//**PURPOSE:      that is entered by the user, an alarm is set from another entered value    **
//**PURPOSE:      from the user. The alarm will then go off at the entered time letting the  **
//**PURPOSE:      user know that the expected temperature is lower than the value that they  **
//**PURPOSE:      entered. Once the user sets the alarm the program uses a service to update **
//**PURPOSE:      the projected low each night. To do this it uses an alarmmanager that goes **
//**PURPOSE:      fires each night at midnight to start the service.                         **
//*********************************************************************************************
